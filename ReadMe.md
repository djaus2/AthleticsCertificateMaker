...
# Updates
- ***Work in progress:*** Moving all text from the background image so it is generated by the Generate powershell scripts. *This will make the re-use of the certificate generator im other contexts simpler.*
  - Title is now in the generate scripts.
